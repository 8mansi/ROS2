...
class SimNode(Node):
    ...
    def __init__(self):
        ...
        self.dstar.obstacles = set()  
        
        # D* planning parameters
        self.dstar_plan_frequency = 10  
        ...
        self.post_episode_reset_delay = 2.5  
    ...
    def check_lane_crossing(self, robot_id, threshold=20):
        ...
        # Camera sees the white line 
        if mean_val > threshold:
            if robot_y > 0: left_flag = 1.0
            else: right_flag = 1.0
        
        # If robot is physically past the line
        if robot_y > boundary:
            left_flag = 1.0
        ...
        if self.dstar_step_counter % 10 == 0:
            ...
            try:
                ...
                path_msg.data = [
                    ...
                    float(goal[0]),
                    float(goal[1]),
                    float(len(self.dstar.obstacles)) 
                ]
